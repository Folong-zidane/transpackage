...
export default function LoginPage() {
  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      window.location.href = '/PickDropDeliver/app/home';
    }, 2000);
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 flex items-center justify-center p-4">
      <div className="max-w-7xl w-full grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-12 p-12 relative">
          ...
          <div className="absolute top-8 left-8 w-20 h-20 bg-emerald-200/30 rounded-full animate-pulse"></div>
          <div className="absolute bottom-12 right-8 w-16 h-16 bg-teal-200/30 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
          <div className="absolute top-1/2 left-4 w-12 h-12 bg-cyan-200/30 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
          
          {/* Header principal */}
          <div className="text-center space-y-8 relative z-10">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-3xl mb-8 shadow-2xl transform hover:scale-110 transition-all duration-500 hover:rotate-3">
              <Truck className="w-12 h-12 text-white" />
            </div>
            <div className="space-y-4">
              <h1 className="text-5xl font-black text-gray-800 leading-tight">
                <span className="bg-gradient-to-r from-emerald-700 to-teal-900 bg-clip-text text-transparent animate-pulse">
                  Pick & Drop
                </span>
                <span className="block text-4xl font-bold text-emerald-700 mt-2">
                  Deliver
                </span>
              </h1>
              <p className="text-xl text-gray-600 max-w-lg mx-auto leading-relaxed">
                Révolutionnez votre service de livraison avec notre plateforme de pointe. 
                <span className="block mt-2 text-emerald-700 font-semibold">
                  Rapide • Fiable • Intelligent
                </span>
              </p>
            </div>
          </div>
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/20 p-8 space-y-8 transform hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="lg:hidden text-center space-y-4">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-full shadow-lg">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white hover:shadow-md"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-600 focus:border-transparent transition-all duration-200 bg-gray-50 focus:bg-white hover:shadow-md"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 cursor-pointer group">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-emerald-700 border-gray-300 rounded focus:ring-emerald-600 transition-all group-hover:scale-110"
                  />
                  <span className="text-sm text-gray-600 group-hover:text-gray-800 transition-colors">Se souvenir de moi</span>
                </label>
                <a href="#" className="text-sm text-emerald-700 hover:text-emerald-800 transition-colors hover:underline">
                  Mot de passe oublié ?
                </a>
              </div>
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-emerald-700 to-emerald-800 hover:from-emerald-800 hover:to-emerald-900 disabled:from-emerald-400 disabled:to-emerald-500 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98] disabled:scale-100 shadow-lg hover:shadow-xl"
              >
                {isLoading ? (
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <a href="#" className="text-emerald-700 hover:text-emerald-800 font-medium transition-colors hover:underline">
                Créer un compte
              </a>
            </p>
          </div>
