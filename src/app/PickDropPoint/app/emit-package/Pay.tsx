...
const Payment: React.FC<PaymentStepProps> = ({ onBack, packageData, formData }) => {
  ...
  const currentUser = {
    name: "Marie Dupont", // Remplacez par les vraies données
    phone: "+237 691 743 511",
    email: "maire.dupont@gmail.com"
  };
  ...
  const paymentMethods = [
    { id: 'card', name: 'Carte bancaire', description: 'Visa, Mastercard', icon: <CreditCardIcon className="w-8 h-8 bg-blue" />, color: 'blue', fees: 0, gradient: 'from-blue-50 to-indigo-100', popular: false },
    { id: 'mobile', name: 'Paiement Mobile', description: 'Orange Money, MTN MoMo', icon: <DevicePhoneMobileIcon className="w-8 h-8 bg-orange " />, color: 'orange', fees: 100, gradient: 'from-orange-50 to-red-100', popular: false },
    { id: 'cash', name: 'Paiement en espèces', description: 'Au dépôt du colis au point relais', icon: <BanknotesIcon className="w-8 h-8" />, color: 'green', fees: 0, gradient: 'from-green-50 to-emerald-100', popular: true },
    { id: 'recipient_pay', name: 'Paiement par le destinataire', description: 'À la réception du colis', icon: <GiftIcon className="w-8 h-8" />, color: 'purple', fees: 0, gradient: 'from-purple-50 to-pink-100', popular: false },
  ];
        ...
        <div className="bg-white p-10 rounded-2xl shadow-2xl border border-gray-100 animate-fadeIn">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            >
              ...
              <Link href='/PickDropPoint/app/home' >
            <button 
