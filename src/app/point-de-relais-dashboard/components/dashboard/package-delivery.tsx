...
import { Camera, Check, FileText, PackageCheck, QrCode, Search, UserCheck } from 'lucide-react';
    ...
    <div className="grid gap-6 grid-cols-1 lg:grid-cols-2">
      <Card className="h-full">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Scannez ou saisissez le numéro de suivi pour livrer un colis
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="scan">
            ...
            <TabsContent value="search" className="space-y-4 mt-4">
              <div className="space-y-4">
                <div>
                  <Label htmlFor="search-tracking">Numéro de suivi ou nom du destinataire</Label>
                  <div className="flex gap-2 mt-1">
                    <Input
                      id="search-tracking"
          ...
          {verificationStep !== null && (
            <div className="mt-6 space-y-4 border-t pt-4">
              ...
              {verificationStep === 1 && (
                <div className="space-y-4">
                  <p className="text-sm">
                    Colis trouvé: <span className="font-medium">TR-7845964</span> pour{' '}
              ...
              {verificationStep === 2 && (
                <div className="space-y-4">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <Button onClick={() => setVerificationStep(3)} className="w-full sm:w-auto">
                      <Camera className="mr-2 h-4 w-4" />
                ...
                <div className="space-y-4">
                  <div className="rounded-lg border p-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-medium">Identité vérifiée</h4>
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 justify-between">
                    ...
                    <Button onClick={() => setVerificationStep(4)} className="w-full sm:w-auto">
                      Continuer
                    </Button>
                  </div>
                </div>
              ...
              {verificationStep === 4 && (
                <div className="space-y-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 justify-between">
                    ...
                    <Button onClick={() => setVerificationStep(5)} className="w-full sm:w-auto">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-600 dark:text-green-400">
                          Le colis TR-7845964 a été remis à Sophie Leroy
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <Card className="h-full">
        <CardHeader className="pb-3">
          <CardTitle>Colis prêts pour livraison</CardTitle>
          <CardDescription>Liste des colis prêts à être livrés</CardDescription>
        </CardHeader>
        <CardContent>
          <ScrollArea className="h-[400px]">
            <div className="w-full overflow-auto">
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-medium">TR-7845964</TableCell>
                    <TableCell>Sophie Leroy</TableCell>
                    <TableCell>
                      <Badge className="bg-green-500 hover:bg-green-600 text-white">Prêt</Badge>
                    </TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">TR-7845975</TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">TR-7845976</TableCell>
                  ...
                  <TableRow>
                    <TableCell className="font-medium">TR-7845977</TableCell>
